...
function displayYoutubeOnOverlay(i, videos, allVideoContent) {
  ...
  if (videoID != undefined) {
    ...
    thumbnail = "<div class='image-thumbnail'><img src='" + videos.result.items[i].snippet.thumbnails.default.url + "' onerror='this.src = 'VentOriginsLogo.png';' alt='playlist-image'></div>";
...
function displaySoundCloudOnOverlay(i, tracks) {
  ...
  if (i < tracks.collection.length) {
    ...
    //Seperating URI and title to parse
    artwork_url = "<div class='image-thumbnail'><img src='" + tracks.collection[i].artwork_url + "' onerror='this.src = 'VentOriginsLogo.png';' alt='playlist-image'></div>";
